...
// --- src/views/IngredientListView.tsx ---
	...
	'ingredientListDisplay.selectAll': {
		fr: "Tout sélectionner",
		en: "Select all",
	},
	'ingredientListDisplay.deselectAll': {
		fr: "Tout désélectionner",
		en: "Deselect all",
	},
	'ingredientListDisplay.generateWithAI': {
		fr: "Générer avec l'IA ({count})",
		en: "Generate with AI ({count})",
	},
	'ingredientListDisplay.generating': {
		fr: "Génération en cours...",
		en: "Generating...",
	},
	'ingredientListDisplay.noNeedsReview': {
		fr: "Aucun ingrédient à valider",
		en: "No ingredients to review",
	},

	'ingredientListView.generation.confirm': {
		fr: "Générer des suggestions pour {count} ingrédient(s) avec l'IA ? Chaque fiche sera créée directement, marquée \"à valider\" — rien n'est utilisé dans vos calculs tant qu'elle n'est pas validée.",
		en: "Generate suggestions for {count} ingredient(s) with AI? Each sheet will be created directly, flagged \"needs review\" — nothing is used in your calculations until you validate it.",
	},
	'ingredientListView.generation.confirmButton': {
		fr: "Générer",
		en: "Generate",
	},
	'ingredientListView.generation.progress': {
		fr: "Génération {current}/{total}...",
		en: "Generating {current}/{total}...",
	},
	'ingredientListView.generation.done': {
		fr: "{success} fiche(s) créée(s){failedSuffix}.",
		en: "{success} sheet(s) created{failedSuffix}.",
	},
	'ingredientListView.generation.failedSuffix': {
		fr: ", {count} échec(s) — voir la console",
		en: ", {count} failure(s) — see console",
	},

	'ingredientDetails.needsReview.banner': {
		fr: "Cette fiche a été générée par l'IA et n'a pas encore été vérifiée.",
		en: "This sheet was generated by AI and hasn't been reviewed yet.",
	},
	'ingredientDetails.needsReview.validate': {
		fr: "Marquer comme validée",
		en: "Mark as validated",
	},

	'ingredientView.validated': {
		fr: "Ingrédient \"{name}\" validé.",
		en: "Ingredient \"{name}\" validated.",
	},

	'ingredientListView.generation.tokenUsage': {
